...
|----|----|----|----|
| [Zarf Init](https://github.com/defenseunicorns/zarf/pkgs/container/packages%2Finit) | v0.30.1 | N/A | A zarf component installed in the cluster for orchestrating further deployment of Zarf based packages |
...
| [DUBBD](https://github.com/defenseunicorns/uds-package-dubbd) | 0.14.0 | N/A | [DESCRIPTION BELOW](#Defense-Unicorns-Big-Bang-Distribution-(DUBBD)) |
| [Keycloak](https://github.com/defenseunicorns/uds-idam) | 0.1.12 | 21.1.1 | An identity and access management (IDAM) tool used to authenticate users for access to applications |
...
| [Gitlab](https://github.com/defenseunicorns/uds-capability-gitlab/tree/main) | 0.1.2 | 16.5.0 | A source control management tool used in the software development lifecycle for storing, updating, building and deploying custom software |
| [Gitlab Runner](https://github.com/defenseunicorns/uds-capability-gitlab-runner/tree/main) | 0.0.8 | v15.11.0 | A counterpart to Gitlab (above) in which automated software builds, tests and deployments are executed |
| [Sonarqube](https://github.com/defenseunicorns/uds-capability-sonarqube) | 0.0.11 | 9.9.2-community | A code inspection tool used during automated pipelines to evaluate security considerations of custom software and packaged images |
| [Jira](https://github.com/defenseunicorns/uds-capability-jira) | 0.0.5 | 9.10.0 | A collaboration tool used for team management and task organization |
| [Confluence](https://github.com/defenseunicorns/uds-capability-confluence) | 0.0.4 | 8.6.0 | A knowledge management tool used by teams to organize information |
| [Mattermost Operator](https://github.com/defenseunicorns/uds-capability-mattermost-operator) | 0.0.2 | 9.0.0 | A Kubernetes operator installed to manage deployment and configuration of Mattermost instances within the cluster |
| [Mattermost](https://github.com/defenseunicorns/uds-capability-mattermost-operator) | 0.0.2 | 9.0.0 | An instance of Mattermost, a self-hosted chat and collaboration platform |
| [Nexus](https://github.com/defenseunicorns/uds-capability-nexus) | 0.0.1 | 3.53.1-02 | An artifact repository used for storing compiled application libraries, packages, images and other such artifacts |
...
| [Big Bang](https://repo1.dso.mil/big-bang/bigbang) | 2.13.1 | Big Bang is a suite of DevSecOps tools which can be installed in Kubernetes to help secure, monitor and manage cluster workloads |
...
| [Istio Operator](https://repo1.dso.mil/big-bang/product/packages/istio-operator) | 1.19.0 | Kubernetes operator which manages deployments and configuration of the Istio service mesh (in-cluster networking) |
| [Istio Controlplane](https://repo1.dso.mil/big-bang/product/packages/istio-controlplane) | 1.19.0 | A package detailing the configuration of the deployed service mesh -- used by the operator to apply the desired state in the cluster |
| [Loki](https://repo1.dso.mil/big-bang/product/packages/loki) | 2.9.1 | A Grafana product for aggregating and querying log data |
| [Promtail](https://repo1.dso.mil/big-bang/product/packages/promtail) | 2.9.1 | A logging daemon installed on each cluster node to capture logs from the host and all cluster workload processes. Logs are shipped to Loki |
...
| [Prometheus](https://repo1.dso.mil/big-bang/product/packages/monitoring) | 2.47.0 | A Grafana product for storing and querying time series based data such as system performance metrics (CPU/MEM usage) |
| [Grafana](https://repo1.dso.mil/big-bang/product/packages/monitoring) | 10.0.3 | A Grafana product to provide a frontend interface to display and query performance information from Prometheus, log data from Loki, and request tracing information from Tempo |
...
| [Tempo](https://repo1.dso.mil/big-bang/product/packages/tempo) | 2.2.2 | A Grafana product for collecting, storing and querying request tracing information; used to help understand how a user's request to an application traversed across the system |
| [Velero](https://repo1.dso.mil/big-bang/product/packages/velero) | 1.11.1 | A tool for orchistrating backups of cluster state and storage |
