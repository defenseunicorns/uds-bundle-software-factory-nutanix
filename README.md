...
<!--x-release-please-start-version-->
    ```bash
    uds pull oci://ghcr.io/defenseunicorns/uds-bundle/software-factory-nutanix-rke2:0.5.2 --architecture amd64`
    ```
...
<!--x-release-please-start-version-->
    ```bash
    uds deploy oci://ghcr.io/defenseunicorns/uds-bundle/software-factory-nutanix-rke2:0.5.2 --architecture amd64`
    ```
<!--x-release-please-end-->
